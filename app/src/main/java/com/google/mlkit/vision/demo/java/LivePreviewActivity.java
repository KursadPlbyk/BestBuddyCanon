...
import com.google.mlkit.vision.demo.java.posedetector.PoseQuer;
...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  private static final String FACE_DETECTION = "Portrait-Modus";
  private static final String POSE_QUER = "Quer";
  private static final String BARCODE_SCANNING = "Barcode Scanning";
  private static final String IMAGE_LABELING = "Image Labeling";
  private static final String IMAGE_LABELING_CUSTOM = "Custom Image Labeling (Birds)";
  private static final String CUSTOM_AUTOML_LABELING = "Custom AutoML Image Labeling (Flower)";
  private static final String POSE_DETECTION = "Ganzkörperbild";
  private static final String POSE2_DETECTION = "Querbild";
    ...
    try {
      switch (model) {
        ...
        case FACE_DETECTION:
          ...
          cameraSource.setMachineLearningFrameProcessor(new FaceDetectorProcessor(this, this));
          break;
        ...
        case POSE_DETECTION:
          ...
          break;
        case POSE_QUER:
          PoseDetectorOptionsBase poseDetectorOptions1 =
                  PreferenceUtils.getPoseDetectorOptionsForLivePreview(this);
          Log.i(TAG, "Using Pose Detector with options " + poseDetectorOptions1);
          boolean shouldShowInFrameLikelihood1 =
                  PreferenceUtils.shouldShowPoseDetectionInFrameLikelihoodLivePreview(this);
