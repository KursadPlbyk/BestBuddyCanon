...
public class PoseGraphic extends Graphic {
  ...
  static boolean POSE_COMPOSITION_VALID = false;
  ...
  public void draw(Canvas canvas) {
    ...
    if (!BestBuddyChecker.checkLandscapeMode(leftFootIndex, rightFootIndex, nose)) {
      // fuß nicht drauf
      POSE_COMPOSITION_VALID = false;
    }else{
      // fuß drauf
      POSE_COMPOSITION_VALID = true;
    }

//    if(!BestBuddyChecker.checkZweiDrittel(leftHip, rightHip)) {
//      // rule of thirds not fulfilled
//      POSE_COMPOSITION_VALID = false;
//    } else {
//      // rule of thirds fulfilled
//      POSE_COMPOSITION_VALID = true;
//    }
