...
import com.google.mlkit.vision.demo.java.BestBuddyChecker;
...
public class FaceGraphic extends Graphic  {
  ...
  static boolean FACE_COMPOSITION_VALID = true;
  ...
  public void draw(Canvas canvas) {
    ...
    if (!BestBuddyChecker.checkPortraitMode(top, left, right, bottom)) {
      boxPaints[0].setColor(Color.RED);
      FACE_COMPOSITION_VALID = false;
      //String buddyCheckerLabel = context.getString(R.string.buddy_checker_result);
      //txt = (TextView) txt.findViewById(R.id.textview5);
      //txt.setText("Falsch");
    }else{
      FACE_COMPOSITION_VALID = true;
      boxPaints[0].setColor(Color.GREEN);
      //txt = (TextView) txt.findViewById(R.id.textview5);
      //txt.setText("Richtig");
    }
