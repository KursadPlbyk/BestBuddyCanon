...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
  ...
  protected void onSuccess(@NonNull List<Face> faces, @NonNull GraphicOverlay graphicOverlay) {
    for (Face face : faces) {
      ...
      TextView textView = (TextView) activity.findViewById(R.id.buddyCheckerLabel);
      if (FaceGraphic.FACE_COMPOSITION_VALID) {
        textView.setText("Person ist im Bild");
        textView.setTextColor(Color.GREEN);
      } else {
        textView.setText("Person ist nicht im Bild");
